<?php
	...
	$sql = "SELECT * FROM products WHERE deleted != 1 AND featured = 1 ";
	$products_featured = $db->query($sql);
?>
	...
	<section class="newproduct bgwhite p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
				<?php while($product = mysqli_fetch_assoc($products_featured)):?>
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->				
						<div class="block2">
							<!-- Change class for new-> block2-labelnew ; sale->block2-labelsale nothing-> don't put block2-label calss -->
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew" style="text-align: center;">
								...
								<div class="block2-overlay trans-0-4">
									...
									<div class="product w-size1 trans-0-4" >
										<!-- Button -->
